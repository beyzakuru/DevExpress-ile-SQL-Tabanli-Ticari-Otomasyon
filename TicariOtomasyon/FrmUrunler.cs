...
namespace TicariOtomasyon
{
    public partial class FrmUrunler : Form
    {
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Ürün Sistemden Silindi.", "Bİlgi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            listele();
        }

        // imlecin satır odağı değiştiği zaman ne olacağını belirlediğimiz metottur.
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            SqlCommand komut = new SqlCommand("Update TBL_URUNLER Set URUNAD=@P1, MARKA=@P2, MODEL=@P3, YIL=@P4, ADET=@P5, ALISFIYAT=@P6," +
                "SATISFIYAT=@P7, DETAY=@P8 where ID=@P9", bgl.baglanti());
            komut.Parameters.AddWithValue("@p1", TxtAd.Text);
            komut.Parameters.AddWithValue("@p2", TxtMarka.Text);
            komut.Parameters.AddWithValue("@p3", TxtModel.Text);
            komut.Parameters.AddWithValue("@p4", MskYil.Text);
