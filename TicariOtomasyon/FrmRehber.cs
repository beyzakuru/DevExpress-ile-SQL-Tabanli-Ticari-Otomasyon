...
namespace TicariOtomasyon
{
    public partial class FrmRehber : Form
    {
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            DataRow dr = gridView1.GetDataRow(gridView1.FocusedRowHandle); //seçilen satırın verisini dr'ye atıyoruz.
        ...
        {
            FrmMail frm = new FrmMail();
            DataRow dr = gridView2.GetDataRow(gridView2.FocusedRowHandle); //seçilen satırın verisini dr'ye atıyoruz.
